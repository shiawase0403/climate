...
const VEGETATION_DB: Record<string, VegetationInfo> = {
  ...
  'Am': {
    name: '热带季雨林 (Tropical Monsoon Forest)',
  ...
  'Csa': {
    name: '亚热带硬叶林 (Sclerophyllous Forest)',
